...
FM_STANDING_WAITS_CEILING_SECS=86400  # longest a held declared-wait recheck may go without being shown to the supervisor before it wakes on its own; unseen counts from the later of the wait's last delivered recheck and its latest status line
