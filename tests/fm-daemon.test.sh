...
pause_fp_housekeeping() {  # <dir> <crew-state-line> [standing-waits-ceiling-secs]
  local dir=$1 crew=$2 ceiling=${3:-86400}
  PATH="$dir/fakebin:$PATH" FM_FAKE_TMUX_WINDOW="sess:fm-held-fp1" FM_FAKE_TMUX_CAPTURE="$dir/pane.txt" \
