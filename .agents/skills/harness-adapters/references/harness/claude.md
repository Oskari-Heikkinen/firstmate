...
A ship or scout nested inside the firstmate home that launches it never meets that dialog for the home's own `@AGENTS.md` import, because its launch excludes the home's instruction files (`../../../../../docs/configuration.md` owns that guarantee).
